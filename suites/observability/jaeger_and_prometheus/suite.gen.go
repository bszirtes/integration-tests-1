...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus?ref=v0.1.30`)
	r.Run(`kubectl wait -n observability --timeout=1m --for=condition=ready pod -l app=opentelemetry`)
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus/example?ref=v0.1.30`)
