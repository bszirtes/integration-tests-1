...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/memory?ref=v0.1.42`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/memory/Kernel2Ethernet2Kernel?ref=v0.1.42`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/memory/Kernel2Kernel?ref=v0.1.42`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/memory/Memif2Memif?ref=v0.1.42`)
