...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/multiforwarder?ref=v0.1.37`)
...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag?ref=v0.1.37`)
...
func (s *Suite) TestKernel2Kernel_Vfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2NoopVlanTag?ref=v0.1.37`)
...
func (s *Suite) TestSriovKernel2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag/ponger?ref=v0.1.37`)
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag?ref=v0.1.37`)
...
func (s *Suite) TestVfio2NoopVlanTag() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Vfio2NoopVlanTag?ref=v0.1.37`)
