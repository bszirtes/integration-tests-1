...
func (s *Suite) SetupSuite() {
	...
	r.Run(`docker exec nse-simple-vl3-docker cp /etc/resolv.conf /etc/resolv_init.conf`)
	r.Run(`docker exec nse-simple-vl3-docker sh -c "echo 'nameserver 127.0.1.1' > /etc/resolv.conf"`)
