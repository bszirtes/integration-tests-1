...
import (
	...
	"github.com/bszirtes/integration-tests-1/suites/k8s_monolith/external_nsc/dns"
	"github.com/bszirtes/integration-tests-1/suites/k8s_monolith/external_nsc/docker"
	"github.com/bszirtes/integration-tests-1/suites/k8s_monolith/external_nsc/spiffe_federation"
...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/k8s_monolith/configuration/cluster?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
