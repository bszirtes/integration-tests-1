...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/ovs?ref=v0.1.42`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2KernelVLAN?ref=v0.1.42`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SmartVF2SmartVF?ref=v0.1.42`)
