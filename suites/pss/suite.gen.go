...
import (
	...
	"github.com/bszirtes/integration-tests-1/suites/spire/single_cluster_csi"
)
...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/pss/nsm-system?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
...
func (s *Suite) TestNginx() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/pss/use-cases/nginx?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
