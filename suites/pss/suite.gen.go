...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/pss/nsm-system?ref=v0.1.33`)
...
func (s *Suite) TestNginx() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/pss/use-cases/nginx?ref=v0.1.33`)
