...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/remotevlan_ovs?ref=v0.1.31`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=v0.1.31`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=v0.1.31`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=v0.1.31`)
	...
	r.Run(`kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3?ref=v0.1.31`)
