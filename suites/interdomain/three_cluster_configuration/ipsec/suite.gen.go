...
import (
	...
	"github.com/bszirtes/integration-tests-1/suites/interdomain/three_cluster_configuration/dns"
	"github.com/bszirtes/integration-tests-1/suites/interdomain/three_cluster_configuration/loadbalancer"
	"github.com/bszirtes/integration-tests-1/suites/interdomain/three_cluster_configuration/spiffe_federation"
	...
	"github.com/bszirtes/integration-tests-1/suites/spire/cluster3"
)
...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/interdomain/three_cluster_configuration/ipsec/cluster1?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/interdomain/three_cluster_configuration/ipsec/cluster2?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/interdomain/three_cluster_configuration/ipsec/cluster3?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56`)
